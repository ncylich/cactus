...
public:
    ...
    size_t attention(size_t query, size_t key, size_t value, float scale, size_t position_offset, size_t window_size, ComputeBackend backend = ComputeBackend::CPU, float softcap = 0.0f);
    ...
    size_t attention_int8_hybrid(size_t query, size_t key_new, size_t value_new, float scale, size_t position_offset,
                                 ...
                                 size_t cache_len, size_t num_kv_heads, size_t head_dim, size_t window_size = 0, float softcap = 0.0f);
