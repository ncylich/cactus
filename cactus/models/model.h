...
class Gemma2Model : public Model {
public:
    Gemma2Model();
    explicit Gemma2Model(const Config& config);
    ~Gemma2Model() override = default;
...
private:
    struct WeightNodeIDs {
        size_t output_weight;
        size_t output_norm_weight;
        float attn_softcap_val = 0.0f;
        float final_softcap_val = 0.0f;
